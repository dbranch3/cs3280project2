...
from utils import is_valid_subnet_mask_ipv4

class IsValidSubnetMaskIpv4Test(unittest.TestCase):
    def test_should_return_true_for_int_under_32(self):
        input = "14"

        output = is_valid_subnet_mask_ipv4(input)
    ...
    def test_should_raise_error_for_invalid_input(self):
        ...
        with self.assertRaises(ValueError):
            is_valid_subnet_mask_ipv4(input)
